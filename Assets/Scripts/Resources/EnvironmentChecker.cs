...
namespace Resources
{
    public class EnvironmentChecker
    {
        ...
        protected EnvironmentChecker(Transform feetPosition, Vector2 sizeCapsule, LayerMask walkLayers,
            float angleCapsule, float delayJumpTime)
        {
        ...
        {
            if (_groundCheck != null) return _groundCheck.GetIsGrounded();
        ...
        {
            if (_groundCheck != null) _groundCheck.OnDrawGizmosSelected();
        }
    }
}